            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <a href="ver_categorias.php" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-[#191d20] hover:text-[#ed2839] hover:border-[#ed2839] focus:outline-none focus:text-[#ed2839] focus:border-[#ed2839]">
                            Ver Categorías
                        </a>
                    </div>
                </div>
